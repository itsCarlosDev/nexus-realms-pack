...
param(
    ...
    [string]$JavaPath = 'C:\Users\spend\AppData\Roaming\PrismLauncher\java\java-runtime-gamma\bin\java.exe',
...
$prismRoot = 'C:\Users\spend\AppData\Roaming\PrismLauncher\instances\NexusRealmsDEV-instance(1)\minecraft'

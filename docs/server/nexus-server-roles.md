...
- usuario: `SpendRed23`
- UUID: `bf5ba90d-6f2a-41e0-8dc2-d58cdedee4a9`
- nivel OP: `4`
- rango interno: `owner`
...
SpendRed23. Dado que no existe otro OP, solo SpendRed23 dispone del panel
administrativo. JourneyMap concede el botón de teleport a los OP aunque el
permiso global esté desactivado, por lo que SpendRed23 conserva el
...
1. SpendRed23 conserva OP 4 y el formato Fundador del Nexus tras reiniciar.

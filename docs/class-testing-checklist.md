...
- `/nexus_givekit warrior <OWNER_NAME>`
- `/nexus_givekit mage <OWNER_NAME>`
- `/nexus_givekit gunslinger <OWNER_NAME>`
- `/nexus_class_debug`
- `/nexus_class_status`
- `/nexus_class_status <OWNER_NAME>`
- `/nexus_testkit warrior <OWNER_NAME>`
- `/nexus_testkit mage <OWNER_NAME>`
- `/nexus_testkit gunslinger <OWNER_NAME>`

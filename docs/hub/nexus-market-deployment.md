...
| Maestro del Metal | `metallurgist_master` | Senda del Metal del Guerrero y orientación de Allomancy | Tienda 3 | Senda del Metal `4E584D4554414C31` | OPERATIVA V1; interior en construcción | `100,75,103`; norte `180` | `/easy_npc preset import_new custom easy_npc:preset/humanoid/metallurgist_master.npc.snbt ~ ~ ~` |
